...
export function lineIntersectsOtherLine(
  line1Point1: [number, number],
  line1Point2: [number, number],
  line2Point1: [number, number],
  line2Point2: [number, number],
): boolean {
  const [x1, y1] = line1Point1
  const [x2, y2] = line1Point2
  const [x3, y3] = line2Point1
  const [x4, y4] = line2Point2
  const denominator =
