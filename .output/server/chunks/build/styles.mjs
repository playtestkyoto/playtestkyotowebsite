...
const styles = {
  ...
  "pages/index.vue": () => import('./index-styles.C1eXZgon.mjs').then(interopDefault),
  ...
  "components/Marquee.vue": () => import('./Marquee-styles.De7xLu4b.mjs').then(interopDefault),
  "components/Home/About.vue": () => import('./About-styles.1WKOtMEI.mjs').then(interopDefault),
  "components/Home/Team.vue": () => import('./Team-styles.CLOpjrYQ.mjs').then(interopDefault),
